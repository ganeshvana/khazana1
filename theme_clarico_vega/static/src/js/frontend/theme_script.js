odoo.define('theme_clarico_vega.theme_script', function(require) {
    ...
    // 04. Shop Events
    //------------------------------------------
    publicWidget.registry.ThemeEvent = publicWidget.Widget.extend({
        ...
        _onRespFilter: function(ev) {
            ...
            $("#products_grid_before").mCustomScrollbar({
               axis:"y", theme:"dark-thin", alwaysShowScrollbar: 1
            });
                ...
                if (!!$stickyFilter.offset()) {
                    if ( (this.stickyTop < scroll) ) {
                        if ( $('.o_top_fixed_element').length ){
                            $('.te_shop_pager_top').css({ position: 'sticky', top: $('header').height(), display: 'flex', width: window.innerWidth, padding: '0px 15px', 'background-color': '#FFF', 'z-index': '9'});
                        } else{
                            $('.te_shop_pager_top').css({position: 'relative', top: 'initial'});
                        }
                    } else {
                        $('.te_shop_pager_top').css({ position: 'relative', top: 'initial', width: window.innerWidth, display: 'flex', padding: '0px 15px', 'background-color': '#FFF', 'z-index':'9' });
                    }
                }
            }
    ...
    function stickyMobileDevice(h8, h9, btnHeight, cookie_height){
        ...
        if( $(h8).length ){
            $('div#wrapwrap .ios-prompt').css({'margin-bottom': '50px'});
    ...
    publicWidget.registry.productDetail = publicWidget.Widget.extend({
        ...
        productGallery: function(){
            ...
            slider.owlCarousel({
                nav:true, rtl: owl_rtl,loop: $('#len-ept-image').val() > 1 ? true : false,rewind: true,
            ...
            // carousel function for thumbnail slider
                thumbnailSlider.owlCarousel({
                    ...
                    margin: 4, rtl: owl_rtl, nav:true, dots: true,
                    navText : ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],
    ...
    $(document).ready(function(){
        ...
        var myCarousel_acce_full = $('.accessory_product_main.full-width .owl-carousel, .alternative_product_main.full-width .owl-carousel').owlCarousel({
            loop: false, rtl: owl_rtl, rewind: true, margin: 10, lazyLoad:true, nav: true, dots: false, autoplay: true, autoplayTimeout: 4000,
            navText : ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],
            autoplayHoverPause:true,
            items: 4,
            responsive: { 0: {items: 1},576: {items: 2},991: {items: 3,},1200: {items: 4,}}
        });

        var myCarousel_acce_prod = $('.accessory_product_main .owl-carousel, .alternative_product_main .owl-carousel').owlCarousel({
            loop: false, rtl: owl_rtl, rewind: true, margin: 10,lazyLoad:true,nav: true,dots: false,autoplay: true,autoplayTimeout: 4000,
            navText : ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],
            autoplayHoverPause:true,items: 2,
    ...
    $('.te_banner_slider_content').owlCarousel({
        loop: true, rtl: owl_rtl, nav: true, dots: false, lazyLoad:true,
        navText : ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],
