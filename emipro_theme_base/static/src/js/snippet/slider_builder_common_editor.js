...
'use strict';
	...
	publicWidget.registry.sliderEditorCommonEpt = publicWidget.Widget.extend({
		...
		getSliderPreview : function(){
            ...
            var params =  {
                'name':name, 'style':style, 'item_ids':item_ids, 'sort_by':sort_by, 'limit':limit, 'product_count':product_count,
            }
        	...
        	if(name === 'brand-slider' || name === 'category-slider'){
				ajax.jsonRpc('/slider/category-brand-render', 'call',params).then(function (data) {
					...
					$('.category_carousel,.brand_carousel').owlCarousel({
						loop: false, rewind: true, margin: 10, rtl : owl_rtl, nav: true, lazyLoad:true, dots: false, autoplay: true, autoplayTimeout: 4000,
						navText : ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'], autoplayHoverPause:true, items: 6,
						responsive: {775: {items:3}}
					});
				...
				ajax.jsonRpc('/slider/render', 'call',params).then(function (data) {
					...
					$('.te_product_slider_1, .te_slider_style_2_right_pannel, .te_product_slider_5, .te_slider_style_6').owlCarousel({
                        loop: false, rtl: owl_rtl, margin: 10, nav: true, lazyLoad:true, dots: false,
                        navText : ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],
                        autoplay: $('.te_auto_play_value span').text() == "True" ? true : false,
                        autoplayTimeout: 4000, autoplayHoverPause:true, items: 4,
                        responsive: {0: {items: 1},576: {items: 1},991: {items: 2},1200: {items: 2},},
                    });
                    $('.te_product_slider_4').owlCarousel({
                        ...
                        items: 1,
                        responsive: {991: {items: 1},1200: {items: 1},
                        },
                    });
                    $('.te_product_slider_banner').each(function(index) {
                        ...
                        $items.owlCarousel({
                            loop: true, rtl: owl_rtl, nav: false, lazyLoad:true, autoplay: true, autoplayTimeout: 4000, autoplayHoverPause:true,
                    ...
                    $('.te_slider_style_7, .te_slider_style_8').each(function(index) {
                        ...
                        $items.owlCarousel({
                            rtl: owl_rtl, nav: false, lazyLoad:true, autoplay: true, autoplayTimeout: 4000, autoplayHoverPause:true, loop: items > 1 ? true : false,
                            items: 1,
